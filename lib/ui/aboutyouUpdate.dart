...
class AboutyouUpdate extends StatefulWidget {
  @override
  _AboutyouUpdateState createState() => _AboutyouUpdateState();
}

class _AboutyouUpdateState extends State<AboutyouUpdate> {
  ...
  void didChangeDependencies() {
    ...
    if (counter == 0) {
      ...
      //     .speciality;
      // _country.text =
      //     Provider.of<ProfileProvider>(context, listen: false).doctor.country;
    }
  }
